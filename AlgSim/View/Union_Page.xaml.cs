...
public partial class Union_Page : ContentPage
{
	public Union_Page()
	{
        ...
        IntersectionDoc.Load(this.GetType().Assembly.GetManifestResourceStream("AlgSim.Resources.ContentXMLs.Union_Content.xml"));
        ...
        task_line_14.Text = IntersectionDoc.SelectSingleNode("Task/TaskLines/Line14").InnerText;
    }
}